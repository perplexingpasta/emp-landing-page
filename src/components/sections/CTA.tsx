...
export function CTA() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1060px] px-4 md:px-6">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="rounded-3xl border border-amber-200 bg-gradient-to-b from-amber-50/80 to-white p-8 text-center shadow-lg shadow-amber-100/50 md:p-12">
            ...
            <p className="mt-4 font-sans text-base leading-relaxed text-stone-500">
              I take on only a handful of colleges per season to ensure quality.
              Let's talk — I'll show you a personalized demo with your college's
              branding.
            </p>
